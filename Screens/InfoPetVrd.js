...
export default function infVidr(){
    return (
      ...
      <View style= {styles.recuadro} >
        ...
        <View>
         <Text style= {styles.title}> PET Verde</Text>
        ...
        style={styles.image}
        source={{
            uri: 'https://gertima.com.mx/wp-content/uploads/2019/10/basuraPET.jpg',
          }} />
        </View>  

        <View>
         <Text style= {styles.texto}> PET Verde implica recolectar, clasificar y procesar estas botellas de plástico para convertirlas en nuevos productos o empaques.</Text>
        </View>
